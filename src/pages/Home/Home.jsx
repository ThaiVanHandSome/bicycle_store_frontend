...
function Home() {
  ...
  return (
    <section className="mt-[94px] xl:mt-[100px]">
      <section
        style={{
          background:
        ...
        <div className="flex flex-col items-center lg:flex-row lg:items-start">
          ...
          <div className="px-8">
            <p className="mb-4 mt-10 text-justify text-medium leading-relaxed">
              ...
              chắn, nhẹ, bền cho mọi điều kiện—bao gồm xe đạp điện, xe leo núi
              và xe đường phố
            </p>
            ...
            <p className="mb-4 text-justify text-medium leading-relaxed">
              Xe đạp nói riêng và các hoạt động thể chất ngoài trời nói chung là
              vô cùng cần thiết cho sự phát triển toàn diện của các bạn nhỏ cũng
              như người trưởng thành. Vận động không chỉ giúp nâng cao sức khỏe
              chống lại bệnh tật, mà còn giúp chúng ta có tinh thần hăng hái,
            ...
            <p className="mb-4 text-justify text-medium leading-relaxed">
              Đạt chất lượng cao với giá thành hợp lý. Mở rộng thị trường với
              các dự án xuất khẩu ra nước ngoài.
            </p>
